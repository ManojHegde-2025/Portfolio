  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-cyan-500/30">
      ...
      <section id="about" className="py-24 bg-slate-900/50 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="w-full md:w-1/3 aspect-square bg-slate-800 rounded-2xl border border-slate-700 p-8 flex flex-col justify-center items-center text-center relative overflow-hidden group">
              ...
              <p className="text-sm text-slate-400"> manojhegde128@gmail.com</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <ProjectCard 
              ...
              description="An automated, conversational chatbot designed to handle dynamic restaurant inquiries and ordering meals using workflow integration platforms(n8n)."
      ...
      <section id="experience" className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-12 flex items-center gap-3">
            <Video className="text-cyan-400" /> Experience
          </h2>
...
function ProjectCard({ title, subtitle, description, tags }) {
  return (
    <div className="bg-slate-950 border border-slate-800 rounded-2xl p-8 hover:border-cyan-500/50 hover:shadow-[0_0_30px_-10px_rgba(6,182,212,0.3)] transition-all group flex flex-col h-full">
      <div className="mb-4">
...
function ExperienceItem({ role, company, date, description }) {
  return (
    <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
      <div className="flex items-center justify-center w-10 h-10 rounded-full border-4 border-slate-950 bg-cyan-500 text-slate-950 shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 shadow-[0_0_0_4px_rgba(15,23,42,1)] z-10">
        <Video size={16} className="fill-current" />
      </div>
      <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-6 rounded-2xl bg-slate-900 border border-slate-800 hover:border-cyan-500/50 transition-colors">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-2">
          <h3 className="font-bold text-xl text-white">{role}</h3>
